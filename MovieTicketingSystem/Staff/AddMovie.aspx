<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Staff.Master" CodeBehind="AddMovie.aspx.cs" Inherits="MovieTicketingSystem.Staff.AddMovie" %>
...
<asp:Content ID="addMovie" ContentPlaceHolderID="main" runat="server">
    ...
    <div class="container">
        <div class="bg-secondary bg-gradient">
            <h1 class="text-heading">Add new Movie
            </h1>
                ...
                <tr>
                    <td colspan="2">
                        <div class="gap-2 btnGroup my-2">
                            <asp:Button ID="btnView" runat="server" Text="Submit" class="btn btn-success" />
                            <asp:Button ID="btnReset" runat="server" Text="Reset" class="btn btn-warning" />
                            <asp:Button ID="btnEdit" runat="server" Text="Cancel" class="btn btn-danger" />
                        </div>
                    </td>
                </tr>
            </table>
