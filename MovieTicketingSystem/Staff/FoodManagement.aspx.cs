...
namespace MovieTicketingSystem.Staff
{
    public partial class FoodManagement : System.Web.UI.Page
    {
        ...
        {
            //step 2 load detail
            string sql = "INSERT INTO Menu VALUES (@menuId, @menuName, @menuCategory, @menuPrice, @menuDesc, @menuRemark)";
            ...
            cmd.Parameters.AddWithValue("@menuRemark", tbRemark.Text);
            ...
            if (dr.Read())
            {
                ...
                tbRemark.Text = dr[5].ToString().Trim();
            }
            else
            {
        ...
        {
            //step 2 load detail
            string sql = "UPDATE Menu SET menuName=@menuName, menuCategory=@menuCategory, menuPrice=@menuPrice, menuDesc=@menuDesc, remark=@remark WHERE menuId=@menuId";
            ...
            cmd.Parameters.AddWithValue("@menuDesc", tbDecs.Text);
            cmd.Parameters.AddWithValue("@remark", tbRemark.Text);
