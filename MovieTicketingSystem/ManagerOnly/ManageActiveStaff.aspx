    ...
    <div class="row">
        <div class="text-white col-md-8" style="height:600px;">
            <div class="nav nav-tabs border-0"id="nav-tab" role="tablist">
                ...
                <asp:Button ID="btnResigned" runat="server" Text="Resigned" CssClass="nav-link w-25 text-white mb-2" OnClick="btnResigned_Click" BorderColor="White" CausesValidation="false"/>
            </div>
