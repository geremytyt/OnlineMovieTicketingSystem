                     ...
                     <tr>
                         <td>
                             <div class="form-floating mb-2">
                                 <asp:TextBox ID="txtMovieID" Enabled="false" placeholder=" " ClientIDMode="Static" runat="server" CssClass="idDisabled form-control userInput"></asp:TextBox>
                                 <label for="txtMovieID" class="requiredField">Movie ID</label>
                             </div>
                         </td>
                         <td>
                             <div class="form-floating mb-2">
