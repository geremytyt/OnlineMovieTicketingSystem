<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Staff.Master" CodeBehind="EditMovie.aspx.cs" Inherits="MovieTicketingSystem.StaffOnly.EditMovie" %>
                 ...
                 <table class="table table-borderless table-responsive text-light">
                     ...
                     <tr>
                         <td>
                             ...
                             <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="Please enter a valid duration (Min.1)" MinimumValue="1" MaximumValue="1000" Type="Integer" ControlToValidate="txtDuration" CssClass="invalid-feedback" Display="Dynamic" SetFocusOnError="true" ></asp:RangeValidator>
                         </td>
                         <td>
