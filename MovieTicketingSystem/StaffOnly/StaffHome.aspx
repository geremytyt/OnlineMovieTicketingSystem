...
<asp:Content ID="Content1" ContentPlaceHolderID="main" runat="server">
    <div class="container my-10"  style="min-height:90vh;">
        ...
        <div class="row mt-3">
            ...
            <div class="row mt-3" style="width:55%;">
                <div class="PaymentDetailsContainer text-white m-3" style="box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);">
                    <h2 class="text-white text-center">Ticket Sales</h2> <hr style="color:white;" />
                        <div class="row m-3">
                            <div class="col-6 m-0">
                                <asp:Label ID="lblTicketSold" runat="server" cssClass="text-white" Text="Total Ticket Sold "></asp:Label>
                            </div>
                            <div class="col-6 m-0">
                    ...
                    <div class="PaymentDetailsContainer text-white m-3" style="box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);">
                        <h2 class="text-white text-center">Summary</h2> <hr style="color:white;" />
                        <div class="row m-3">
                            <div class="col-6 m-0">
                                <asp:Label ID="Label3" runat="server" Text="Total Sales Earned "></asp:Label>
                            </div>
                            <div class="col-6 m-0 ">
                          ...
                          <div class="row m-3">
                            <div class="col-6 m-0">
                                <asp:Label ID="Label4" runat="server" Text="Number of Ongoing Movie "></asp:Label>
                            </div> 
                            <div class="col-6 m-0">
                                <asp:Literal ID="litMovie" runat="server"></asp:Literal>
                            </div> 
                        </div> 
                        <div class="row m-3">
                            <div class="col-6 m-0">
                                <asp:Label ID="Label5" runat="server" Text="Number of Schedule "></asp:Label>
                            </div> 
                            <div class="col-6 m-0">
                                <asp:Literal ID="litSche" runat="server"></asp:Literal>
                            </div> 
                        </div>
                    </div>
            </div>
