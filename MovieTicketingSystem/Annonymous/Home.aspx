        ...
        <div class="row">
            ...
            <nav class="col-lg-10">
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <button class="loginTab nav-link" id="coming-soon-tab" data-bs-toggle="tab" data-bs-target="#coming-soon" type="button" role="tab" aria-controls="coming-soon" aria-selected="false">Coming Soon</button>
                    <button class="loginTab nav-link" id="top-selling-tab" data-bs-toggle="tab" data-bs-target="#top-selling" type="button" role="tab" aria-controls="top-selling" aria-selected="false">Top Selling</button>
                </div>
            </nav>
